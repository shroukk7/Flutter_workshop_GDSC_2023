void main(List<String> args) {
  ...
  List<int> filteredNumbers = numbers2.where((x) => x > 3).toList();
  ...
  List<String> filteredNames = names2.where((x) => x.startsWith('A')).toList();
  print(filteredNames);
  ...
  List<String> filteredNames2 =
      names3.where((x) => x.startsWith('A') && x.endsWith('d')).toList();
  ...
  int firstNumberGreaterThan4 = numbers3.firstWhere((x) => x > 4);
  ...
  List<Map<String, String>> johns =
      people.where((x) => x['name'] == 'John').toList();
  print(johns);
